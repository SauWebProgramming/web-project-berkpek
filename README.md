...
Bu proje, **Sakarya Üniversitesi Web Tasarımı ve Programlama** dersi kapsamında hazırlanmış kişisel portfolyo web sitesidir. 

Site; modern web teknolojileri kullanılarak, dinamik veri çekme (JSON) ve kullanıcı etkileşimi (Dark Mode) özellikleri barındıracak şekilde tasarlanmıştır.
...
* **JavaScript (ES6+):** DOM manipülasyonu ve Asenkron veri çekme (Fetch API).
* **JSON:** Veri depolama.

## 📂 Kurulum (Bilgisayarınızda Çalıştırmak İçin)
